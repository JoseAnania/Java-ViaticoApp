...
public class AltaViatico extends javax.swing.JFrame {
    ...
    {
        ArrayList<Empleado>lista=C.comboE();
        DefaultComboBoxModel modelo=new DefaultComboBoxModel();
        modelo.addElement("Seleccione");
        for (Empleado E : lista) {
            modelo.addElement(E.getNombre());
        }
        cboEmpleado.setModel(modelo);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Alta de Viáticos");
        ...
        btnAlta.setText("Alta de Viático");
    ...
    private void btnAltaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAltaActionPerformed
        ...
        int idViatico=0;
        int legajo=(int) cboEmpleado.getSelectedIndex();
        String concepto=txtConcepto.getText();
        float importe=Float.parseFloat(txtImporte.getText());
        
        Viatico V=new Viatico(idViatico, legajo, concepto, importe);
        C.agregarViatico(V);
        limpiarCampos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AltaViatico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AltaViatico().setVisible(true);
            }
        });
    }
